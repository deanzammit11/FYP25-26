...
def plot_results_by_season():
    ...
    df = pd.read_csv("data/processed/eng1_all_seasons.csv") # Loads the dataset containing all the seasons combined
    ...
    count.to_csv("data/results/results_by_season.csv") # Total occurence for each result is saved in results_by_season_count.csv
    ...
    plt.savefig("data/results/results_by_season.png", dpi=200) # Figure is saved to the specified path and resolution is set
